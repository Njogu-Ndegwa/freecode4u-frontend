...
import { deleteManufacturer } from '../services/inventoryService';
...
export const actions = ({ row, onDelete }: ActionProps) => {
    ...
    const handleEdit = () => {
        router.push(`/inventory/manufacturers/edit/${row.id}`);
    };
    ...
    const handleConfirmDelete = async () => {
        try {
            ...
            const response = await deleteManufacturer(row.id);
    ...
    return (
        <>
            ...
            <FeedbackModal
                ...
                content="Are you sure you want to delete this Manufacturers?"
